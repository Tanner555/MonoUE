...
{
    // mirrors FUNC_* property flags from Engine/Source/Runtime/CoreUObject/Public/UObject/Script.h
    // If these change enough may be worth doing a regex of Script.h to generate this enum as a msbuild task
#if CLSCOMPLIANT
    ...
    public enum FunctionFlags : ulong
    {
        ...
        // 0x00008000,   // unused.
        /// <summary>Function is a multi-cast delegate signature (also requires FunctionFlags.Delegate to be set!)</summary>
        ...
        /// <summary>Function is delegate signature (either single-cast or multi-cast, depending on whether FunctionFlags.MulticastDelegate is set.)</summary>
        Delegate = 0x00100000,
        ...
        /// <summary>function can be called from blueprint code, and is also pure (produces no side effects). If you set this, you should set FunctionFlags.BlueprintCallable as well.</summary>
