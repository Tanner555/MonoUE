...
{
    // mirrors EPropertyFlags property flags from Engine/Source/Runtime/CoreUObject/Public/UObject/ObjectMacros.h
    // If these change enough may be worth doing a regex of UObjectMacros.h to generate this enum as a msbuild task
#if CLSCOMPLIANT
    ...
    public enum PropertyFlags : ulong
    {
        ...
        /// <summary>Property contains subobject references (TSubobjectPtr)</summary>
        SubobjectReference = 0x0000000000400000,
        // Unused = 0x0000000000800000,
        /// <summary>Property should be serialized for save games</summary>
        SaveGame = 0x0000000001000000,
        /// <summary>Hide clear (and browse) button.</summary>
        NoClear = 0x0000000002000000,
        // Unused = 0x0000000004000000,	//
        /// <summary>Value is passed by reference; PropertyFlags.OutParam and PropertyFlags.Param should also be set.</summary>
