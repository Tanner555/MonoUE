...
{
	class TP_ThirdPersonMonoBPCharacter : Character
	{
		...
		protected TP_ThirdPersonMonoBPCharacter (ObjectInitializer initializer)
			: base (initializer)
		{
		...
		protected TP_ThirdPersonMonoBPCharacter (IntPtr nativeObject)
			: base (nativeObject)
		{
		}
